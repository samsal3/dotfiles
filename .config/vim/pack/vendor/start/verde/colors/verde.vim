...
" Based on Jonathan Blow's emacs color theme
...
hi Normal             guibg=#041818  guifg=#D3B58D gui=NONE ctermbg=00 ctermfg=07 cterm=NONE
hi NonText            guibg=bg       guifg=fg      gui=NONE ctermbg=bg ctermfg=fg cterm=NONE
hi StatusLine         guibg=#0C4848  guifg=#000000 gui=NONE ctermbg=09 ctermfg=15 cterm=NONE
hi StatusLineNC       guibg=#062424  guifg=#000000 gui=NONE ctermbg=11 ctermfg=15 cterm=NONE
...
hi VertSplit          guibg=#062424  guifg=#000000 gui=NONE ctermbg=11 ctermfg=15 cterm=NONE
hi Folded             guibg=bg       guifg=#00A600 gui=NONE ctermbg=bg ctermfg=02 cterm=NONE
hi FoldColumn         guibg=#fcfcce  guifg=fg      gui=NONE ctermbg=bg ctermfg=02 cterm=NONE
...
hi Statement          guibg=bg       guifg=#E5E5E5 gui=NONE ctermbg=bg ctermfg=15 cterm=NONE
hi Identifier         guibg=bg       guifg=fg      gui=NONE ctermbg=bg ctermfg=fg cterm=NONE
hi Type               guibg=bg       guifg=#E5E5E5 gui=bold ctermbg=bg ctermfg=15 cterm=NONE
hi PreProc            guibg=bg       guifg=fg      gui=bold ctermbg=bg ctermfg=fg cterm=NONE
hi Constant           guibg=bg       guifg=#D7FFAF gui=bold ctermbg=bg ctermfg=10 cterm=NONE
